...
% Ajout Cyril :
% \usepackage[linktocpage=true,linkcolor=cyan,citecolor=cyan,colorlinks=true,urlcolor=cyan,pagebackref]{hyperref}
% Hyoerlink en noir
\usepackage[linktocpage=false,colorlinks=false]{hyperref}
...
\begin{singlespace}
  ...
  \bibliography{library.bib} % Ici mettre le nom de la biblio, ici library.bib
\end{singlespace}
