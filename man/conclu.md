...
Cela dit, en partant de ce principe et en optant pour l’utilisation d’un espace explicatif fait exclusivement de variables abiotiques, le risque est très fort d'attribuer la co-occurrence aux variables abiotiques alors que la cause profonde de cette co-occurrence pourrait être l’interaction entre les espèces.
...
[^ipbes]: L'IPBES a été construit sur le même modèle que le GIEC en ayant pourtant un mandat plus large&nbsp: en plus de faire une synthèse des connaissances en vue de guider les décideurs politiques, elle a une action dans la production de nouvelles connaissances [@Brooks2014].
...
En dépit de la pertinence de ses développements, Lawton oublie, à mon avis, de répondre à une question centrale&nbsp;: quels sont les objets des prédictions ?
...
Il me semble que présenté ainsi, l'objectif de prédiction fiable semble bien plus réalisable que celui présenté par Lawton. La contingence des systèmes biologiques nous indique qu’il faut un formalisme qui envisage des possibilités et non pas la supposition d’existence de règles dans ces systèmes.
...
Les top-prédateurs par exemple&nbsp;: ces espèces des niveaux trophiques les plus élevés structurent profondément les communautés, leur extinction ont de fortes influences sur l’ensemble de la communautés [@Terborgh2001; @Sinclair2003a; @Myers2007; @Ripple2014].
...
Pour cela, nous devons chercher et trouver le liant entre tous ces processus et examiner soigneusement
