...
François Massol a notamment contribué à la formalisation mathématique de l'article.
Pour aller plus loin, François Massol a envisagé d'explorer un peu plus les
possibilités offertes par la ITIB et notamment développer le formalisme mathématique
autour de la TTIB. Francois Massol a été invité à partcipé au volume XX sur XX de \emph{Advances in Ecological Research}
dont il est co-éditeur.
Cette opportunité a été idéale pour entreprendre de longs développements sur les
mathématiques de la TTIB.
J'ai été alors invité à perticiper au projet pour y détailler un modèle basé sur les
transitions entre réseaux trophiques.
Dans cette annex, je présente ma participation à l'article avant qu'elle ne soit intégrer.
J'ai aussi participé à la relecture et aux discussion mais le texte final n'est pas de moi,
de fait je n'ai pas intégrer l'ensemble de l'article.
La figure qui y est présentée est de Francois Massol qui m'a getillemt permi de la réutiliser
Cette article a été écrtie en collaboration avec
François Massol, Maxime Dubart, Vincent Calcagno, Claire Jacquet, Sonia Kéfi et Dominique Gravel
a notation représente $\P_(X)$ la probabilité de l'événement $X$, c'est donc comme équivalent $\mathbb{P}(X)$
Il a été pour l'occasion de valoriser mon travail montré à lmaanex \ref{annII}.
