...
\begin{figure}
\centering
\includegraphics[width=0.82000\textwidth]{chapitre3/figConcept.pdf}
...
\caption[R and packages used for the analyses]{R and packages used for the analyses. GLM: Generalized Linear
...
\caption[Total number of species]{For each datasets we provide the total number of species
...
\caption[Tree species and traits used in the study]{Tree species and traits used in the study. Abbreviations are as follows: TSN
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{chapitre3/figS1.png}
...
\caption[Co-occurrence and the nature of the trait-based
distance in the FBBS dataset]{\textbf{Co-occurrence and the nature of the trait-based
