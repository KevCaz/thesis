...
occupancy of preys increases]{\textbf{Co-occurrence significance decreases as the cumulated
...
\caption[R and packages used for the analyse]{R and packages used for the analyses. GLM: Generalized Linear
...
\caption[Number of species considered]{For each datasets we provide the total number of species
...
\caption[Tree species and traits considered in the study]{Tree species and traits considered in the study. Abbreviations are as follows: TSN
...
\begin{longtable}[]{@{}lr@{}}
\caption[Traits considered for the FBBS dataset]{List of the Boolean traits used to compute Euclidean distances
...
\caption[Sites of the study]{\textbf{Sites of the study}\label{fig:maps}}
\end{figure}
...
\caption[Evaluation of the SDMs]{\textbf{Evaluation of the SDMs}. For each dataset, the
...
\caption[Co-occurrence and the trait-based
distance used for the FBBS dataset]{\textbf{Co-occurrence and the trait-based
distance used for the FBBS dataset}. The different panels correspond to four
...
\caption[Changes in co-occurrence signal with increased distance
between two species]{\textbf{Changes in co-occurrence signal with increased distance
...
of the co-occurrence strength]{\textbf{The degree of species partially explains the decrease
...
\caption[Co-occurrence and cumulated occupancy of predators]{\textbf{Co-occurrence and cumulated occupancy of predators}.
...
\caption[Predicting herbivore distribution based on the
distribution of willows]{\textbf{Predicting herbivore distribution based on the
