...
modèle mathématique donnant une explication simple et convaicante des
...
problèmes de définition.\footnote{En 1957, Hutchinson propose de voir la
  ...
  plus claire de la niche écologique, certins auteurs proposent de
  ...
  l'aspect plus quantitatif de cette définition, un problème substiste,
...
pour aller essayer de comprender les répartitions futures. De manière
...
les distributions locales et régionales de 48 espèces d'arbres étaint
bien expliquées par la sensibilité à la sécheresse, donc à une variation
...
celles qui seront transmises à la desendance, alors ces modifications
...
1967). La relation aire-espèce surtout connue pour ses applications dans
le domaine de la conservation\footnote{Récemment Wilson a répondu à une
