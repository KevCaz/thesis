...
larges\footnote{L'âge de la terre est très débattu à l'époque. Bien que
  l'ensemble des savants s'accordent pour aller bien au-delà des 6000
  ans bibliques, il n'y a alors pas de consensus. Wallace affirme à la
  page 212 du chapitre 10 de \emph{Island Life} que la vie se
...
troisième temps de cette introduction, je reviens amplement sur ce cadre
théorique appelé théorie de la biogéographie des îles (noté TIB dans la
suite pour \emph{Theory of Island Biogeography}).
...
que chacune avancent en faisant des hypothèses fortes sur l'autre qui
...
étudient avec 95 règles\footnote{Une variante indique que les
  ...
  Je pense que pour ce concerne nos capacités de prédictions, la
...
entre autre, de quantifier la plausibilité d'une hypothèse donnée au
...
rester possibles entre individus d'une même espèce. À l'échelle des
...
propre et des singularités physiologiques qui en découlent. À son
...
\caption{\textbf{La Théorie de la Biogéographie des Îles (TIB)} (A)
