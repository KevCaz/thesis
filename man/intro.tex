...
discipline. Parmi les étapes majeures de ce renouvellement figure
l'intégration des interactions écologiques au sein d'une théorie plus
intégrative de la biogéographie. C'est sur ce point qu'ont porté mes
travaux de thèse. J'ai particulièrement réfléchi sur comment intégrer
les interactions dans les modèles de distribution d'espèces,
c'est-à-dire envisager le rôle joué par ces liens écologiques dans la
géométrie de leur répartition géographique.
...
(séparant les îles de Bali et Lombok mentionnée au paragraphe
...
cadre théorique appelé théorie de la biogéographie des îles (noté TIB
dans la suite pour \emph{Theory of Island Biogeography}).
...
modèles nuls de cooccurrence \citep{Connor1979} et sur laquelle mon
...
d'équations dérivées d'une théorie et de savoirs empiriques. Les
modèles, quelle qu'en soit leur nature, sont des objets avec lesquels il
est possible d'explorer et de tester une théorie.
...
physique nous a donné deux exemples très probants du pouvoir de
l'imagination doublé du cadre rigoureux des mathématiques avec la
vérification expérimentale de théories énoncées bien avant que les
...
du Boson de Higgs dont l'existence fut prédite en 1964\footnote{Pour
  plus de détail, je renvoie le lecteur au bulletin du CERN disponible
  en ligne
...
meilleur des cas, très compliqué. Néanmoins, dans les mouvements de
grandes amplitudes se manifestent des processus qui agissent en
...
même d'une communauté locale d'insectes. À l'échelle d'un continent,
...
sècheresse, donc à une variation dans la disponibilité d'une ressource.
Ces corrélations convaincantes fondent les SDMs qui sont des solutions
techniques (statistiques) pour l'application de la méthode générale que
je viens de décrire \citep{Elith2006, Elith2009a}.
...
les modèles climatologiques, s'il n'existe pas d'obstacle majeur au
...
l'espèce ~» qu'ils souhaitaient construire \citep[
p.183]{MacArthur1967}.
...
caractéristiques de l'île. Dès leur article de 1963, MacArthur et Wilson
présentent la taille de l'île comme un facteur affectant le taux
...
l'augmentation linéaire du nombre d'espèces de l'herpétofaune avec le
...
conservation\footnote{Récemment, Wilson a répondu à une entrevue dans
  ...
  espèces sans pour autant empêcher le développement humain
...
\caption[La Théorie de la Biogéographie des Iles (TIB)]{\textbf{La Théorie de la Biogéographie des Îles (TIB)} (A)
...
phénomène contrebalancé par l'apparition d'espèces nouvelles
...
La thèse que je présente a pour objectif de trouver des pistes pour
...
remarque ainsi~: «~\emph{Both competition and predation appear now to be
much more important in biogeography than people had formely guessed}~»
\citep[ p.28]{wallace1881island}.
